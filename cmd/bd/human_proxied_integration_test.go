...
//
// The `bd human respond` leg is intentionally NOT covered here: it needs
// AddIssueComment, which the domain CommentUseCase does not expose (read-only),
// so it is an interface-extension blocked on the aocj comment work.
