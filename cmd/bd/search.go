...
func init() {
	...
	searchCmd.Flags().StringP("status", "s", "", "Filter by stored status ("+statusFilterHelpList()+"). Default excludes closed; use 'all' to include closed. Note: dependency-blocked issues use 'bd blocked'")
