...
// beads-sdmy) and the GitLab "bd:estimate:" guard (beads-yl92) — the
// reserved-marker-in-label collision axis, distinct from the whitespace/
// delimiter guards. beads-nqu1.
